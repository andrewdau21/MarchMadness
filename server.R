...
function(input, output, session) {
  ...
  observe({
    ...
    compiled_url <-  paste0('http://site.api.espn.com/apis/site/v2/sports/basketball/mens-college-basketball/scoreboard?lang=en&region=us&limit=500&dates=', temp_date, '&groups=50')
      ...
      espn_season_2018_final <- espn_season_2018_final %>%
        select( away_team_abb, away_score,home_team_abb, home_score,time, period,home_logo, away_logo, current_stat) %>%
      ...
      #values$df_data <- espn_season_2018_final
  ...
  output$standings <- DT::renderDataTable({
    ...
    #library(DT)
    datatable(
      cbind(' ' = '&oplus;', standings), escape = FALSE,
      options = list(
        selection = 'single',
        dom = 't',
        autoWidth = TRUE,
        ...
        columnDefs = list(
          ...
          list(visible = FALSE, targets = c(0,4,5,6,7,8,9,10)),
  ...
  var format = function(d) {
    ...
    '<img src=\"https://a.espncdn.com/i/teamlogos/ncaa/500/'+d[4] + '.png\" width = \"32\" height = \"32\"</img> ' +
    '<img src=\"https://a.espncdn.com/i/teamlogos/ncaa/500/'+d[5] + '.png\" width = \"32\" height = \"32\" opacity = .2 </img> ' +
    '<img src=\"https://a.espncdn.com/i/teamlogos/ncaa/500/'+d[6] + '.png\" width = \"32\" height = \"32\"</img> ' +
  '<img src=\"https://www.whitehotel.com/files/img/bg-lines.png\" width = \"1\" height = \"1\"</img> ' +
    ...
    '<img src=\"https://a.espncdn.com/i/teamlogos/ncaa/500/'+d[11] + '.png\" width = \"1\" height = \"1\"</img> ' 
